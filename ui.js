...
export function render() {
  ...
  const a = window.alerts ? window.alerts() : []; document.getElementById('alarm').innerHTML = a.length ? '<span class="badge bExp" data-act="showAlertsDlg" style="cursor:pointer" title="Показать тревоги">! ' + a.length + '</span>' : ''; updHead();
