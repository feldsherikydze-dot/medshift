...
export function loginView() {
  ...
  h += '</div></div>';
  h += '<p style="text-align:center;font-size:calc(var(--fs) - 4px);color:var(--mut);margin-top:10px">MedShift · версия v' + VERSION + ' · справочник: ' + (window.SEED ? window.SEED.length + ' преп. 💊' : '⚠ справочник не загружен') + '</p>';
  return h;
}
