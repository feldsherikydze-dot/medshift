...
export const APP = {
  ...
  phone: '203-03-03',
  footer: 'ООО «КрасНЕО» — первая частная скорая помощь · Красноярск, пр. Металлургов 8 · тел. 203-03-03',
...
export const LIMITS = {
  ...
  SESSION_TTL_MS: 86400000, LEAVES_COUNT_MOBILE: 12, LEAVES_COUNT_DESKTOP: 18,
